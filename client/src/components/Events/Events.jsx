      ...
      <div className={`${styles.section}`}>
        <div className={`${styles.heading}`}>
          <div className="flex items-center justify-between">
            <p className="text-[36px]">Popular Events</p>
            <div>
        ...
        <div className="grid xl:grid-cols-2 lg:grid-cols-1 sm:grid-cols-1 grid-cols-1 xl:gap-[30px] gap-5 mb-20">
          {allEvents && allEvents.length !== 0 && (
            <>
              {allEvents &&
                allEvents.map((i, index) => <EventCard data={i} key={index} />)}
            </>
          )}
        </div>
        {allEvents && allEvents?.length === 0 && (
          <>
            <h4 className="w-full grid h-40 flex text-center pt-10 bg-white mb-9">
              No Events Available!
            </h4>
          </>
        )}
