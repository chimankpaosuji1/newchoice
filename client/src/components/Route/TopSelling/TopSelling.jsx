...
import TopProductCard from "../TopProductCard/TopProductCard.jsx";
    ...
    <div className={`${styles.section}`}>
      <div className={`${styles.heading}`}>
        <div className="flex items-center justify-between">
          <p className="text-[36px]">Top Selling Products</p>
          <div>
            <div className="flex space-x-2 items-center">
              <p className=" font-600 text-qblack text-[22px]">View More</p>
      ...
      <div className="grid xl:grid-cols-2 lg:grid-cols-2 sm:grid-cols-2 grid-cols-1 xl:gap-[30px] gap-5 mb-12">
        {data && data.length !== 0 && (
          <>
            {data &&
              data.map((i, index) => <TopProductCard data={i} key={index} />)}
          </>
        )}
      </div>
    </div>
